...
<?php foreach ($pages as $page):
	...
	<?php $i++; endif; endforeach; ?>
		...
		<!--<div id="dramaFiction" class="listView">
			<h2><a href="/all-niyay/drama">นิยายดราม่า</a></h2>
			<div class="displayDrama">
				<?php //$a = new Area('Drama'); $a->display($c); ?>
			</div>
		</div>

		<div id="romanticFiction" class="listView">
			<h2><a href="/all-niyay/romantic">นิยายรักโรแมนติก</a></h2>
			<div class="displayRomantic">
				<?php //$a = new Area('Romantic'); $a->display($c); ?>
			</div>
		</div>


		<div id="comedyFiction" class="listView">
			<h2><a href="/all-niyay/comedy">นิยายคอมเมดี้</a></h2>
			<div class="displayComedy">
				<?php //$a = new Area('Comedy'); $a->display($c); ?>
			</div>
		</div>

		<div id="eroticFiction" class="listView">
			<h2><a href="/all-niyay/erotic">นิยายอีโรติก</a></h2>
			<div class="displayRomance">
				<?php //$a = new Area('Erotic'); $a->display($c); ?>
			</div>
		</div>

		<div id="fantasyFiction" class="listView">
			<h2><a href="/all-niyay/fantasy">นิยายแฟนตาซี</a></h2>
			<div class="displayFantasy">
				<?php //$a = new Area('Fantasy'); $a->display($c); ?>
			</div>
		</div>

		<div id="investigateFiction" class="listView">
			<h2><a href="/all-niyay/investigate">นิยายสืบสวนสอบสวน</a></h2>
			<div class="displayInvestigate">
				<?php //$a = new Area('Investigate'); $a->display($c); ?>
			</div>
		</div>

		<div id="actionFiction" class="listView">
			<h2><a href="/all-niyay/action">นิยายบู๊/ต่อสู้</a></h2>
			<div class="displayAction">
				<?php //$a = new Area('Action'); $a->display($c); ?>
			</div>
		</div>

		<div id="yFiction" class="listView">
			<h2><a href="/all-niyay/y">นิยายวาย</a></h2>
			<div class="displayY">
				<?php //$a = new Area('Y'); $a->display($c); ?>
			</div>
		</div>

		<div id="fanficFiction" class="listView">
			<h2><a href="/all-niyay/fanfic">นิยายแฟนฟิค</a></h2>
			<div class="displayFanfic">
