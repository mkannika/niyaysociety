...
$v->setThemeByPath('/login', "niyaysociety");
$v->setThemeByPath('/page_forbidden', "niyaysociety");
$v->setThemeByPath('/register', "niyaysociety");
$v->setThemeByPath('/members', "niyaysociety");*/